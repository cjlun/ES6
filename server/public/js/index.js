...
var _templateObject = _taggedTemplateLiteral(['I am ', ' , and ', ''], ['I am ', ' , and ', '']),
    _templateObject2 = _taggedTemplateLiteral(['a\nb'], ['a\\nb']);
...
{
	var _result3 = function _result3() {
	...
	var _result4 = _result3();

	var _result5 = _slicedToArray(_result4, 5);
...

{
	var _a6 = { a: 10 },
	    _a6$a = _a6.a,
	    _a5 = _a6$a === undefined ? 3 : _a6$a,
	    _a6$b = _a6.b,
	    _b5 = _a6$b === undefined ? 5 : _a6$b;
...

{
	...
	var _o$ = _o[0],
	    title = _o$.title,
	    _o$$content = _slicedToArray(_o$.content, 1),
	    content = _o$$content[0].title;

	console.log(title, content);
}

{
	var regExp1 = new RegExp('xyz', 'ig');
	var regExp2 = new RegExp(/xyz/ig, "iy");
	var str = 'XYZXYZ';
...

{
	...
	console.log(_s.charAt(0));
	console.log(_s.charAt(1));
	console.log(_s.charCodeAt(0));
	console.log(_s.charCodeAt(1));
	console.log(_s.codePointAt(0).toString(16));
	console.log(_s.codePointAt(0).toString());
	console.log(_s.codePointAt(1));
	console.log('\uD842\uDFB7');
	console.log('\u20BB7');
}

{
	...
	try {
		for (var _iterator = _s2[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
{
	var _s3 = 'string';
	console.log(_s3.includes('str'));
	console.log(_s3.startsWith('str'));
	console.log(_s3.endsWith('ing'));
	console.log(_s3.repeat(3));
}

{
	var name = 'lun';
	var template = 'I am ' + name;
...

{
	...
	var _name = 'lun',
	    age = 18;
	console.log(abc(_templateObject, _name, age));
}
...
{
	console.log('二进制0b', 503);
	console.log('八进制0o', 503);
}
...

{
	...
	try {
		for (var _iterator3 = ['a', 'b', 'c'].values()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	try {
		for (var _iterator4 = ['a', 'b', 'c'].entries()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...

{
	var _f = function _f() {
		...
		try {
			for (var _iterator5 = arg[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
{
	var _a7 = 'b';
	var _o2 = _defineProperty({}, _a7, 'I am b');
	console.log(_o2);
}

{
	...
	var _template = { a: 1, b: 1, c: 1 },
	    copy = {};
	Object.assign(copy, _template);
	console.log(copy);
}

{
	...
	try {
		for (var _iterator6 = Object.entries(_o4)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
			var _step6$value = _slicedToArray(_step6.value, 2),
			    _key2 = _step6$value[0],
			    _value = _step6$value[1];

			console.log(_key2 + ':' + _value);
		}
	} catch (err) {
...
{
	var _a9 = Symbol.for('a');
	var _b7 = Symbol.for('b');
	console.log(_a9 === _b7);
	var c = Symbol.for('a');
	console.log(_a9 === c);
}

{
	...
	var _a10 = Symbol.for('a');
	var _o5 = (_o6 = {}, _defineProperty(_o6, _a10, 123), _defineProperty(_o6, 'a', 456), _defineProperty(_o6, 'b', 'b'), _o6);
	console.log(_o5);
	var symbol = Object.getOwnPropertySymbols(_o5);
	console.log(symbol);
	symbol.forEach(function (item, index) {
		console.log(index, item, _o5[item]);
	});
	console.log(Reflect.ownKeys(_o5));
	Reflect.ownKeys(_o5).forEach(function (item) {
		console.log(_o5[item]);
	});
}
...

{
	...
	var _set = new Set(_arr);
	console.log(_set, _set.size);
	var _iteratorNormalCompletion7 = true;
	var _didIteratorError7 = false;
	var _iteratorError7 = undefined;

	try {
		for (var _iterator7 = _set.entries()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
			var _step7$value = _slicedToArray(_step7.value, 2),
			    _key3 = _step7$value[0],
			    _value2 = _step7$value[1];

			console.log(_key3, _value2);
		}
	} catch (err) {
...
{
	var _arr2 = [['a', 1], ['b', 2], ['c', 3]];
	var map = new Map(_arr2);
	console.log(map);
	map.set('a', 3);
	map.delete('c');
	console.log(map);
...

{
	...
	console.log(proxy);
	Object.keys(proxy).forEach(function (item) {
...
{
	var _arr3 = ['a', 'b', 'c'];
	var _map = _arr3[Symbol.iterator]();
	console.log(_map.next());
	console.log(_map.next());
	console.log(_map.next());
	console.log(_map.next());
	console.log(_map.next());
...

{
	...
	try {
		for (var _iterator9 = [1, 2, 3, 4].keys()[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
			var _value4 = _step9.value;
...
{
	//generator
	var _f2 = /*#__PURE__*/regeneratorRuntime.mark(function _f2() {
		return regeneratorRuntime.wrap(function _f2$(_context) {
			while (1) {
	...
	var _obj2 = {};
	_obj2[Symbol.iterator] = /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	...
	try {
		for (var _iterator10 = _obj2[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	...
	var tell = _obj2[Symbol.iterator]();
	console.log(tell.next());
	console.log(tell.next());
	console.log(tell.next());
	console.log(_obj2[Symbol.iterator]());
	console.log(_obj2[Symbol.iterator]());
	console.log(_obj2[Symbol.iterator]());
}
...

{
	...
	_obj3[Symbol.iterator] = /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
		var arr, _index2;
		...
		return regeneratorRuntime.wrap(function _callee2$(_context4) {
			while (1) {
				switch (_context4.prev = _context4.next) {
					...
					case 2:
						if (!(_index2 < arr.length)) {
							_context4.next = 8;
							break;
						}

						_context4.next = 5;
						return _obj3[arr[_index2]];
	...
	try {
		for (var _iterator11 = _obj3[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
			var _value6 = _step11.value;
...

{
	...
	try {
		for (var _iterator12 = _arr4[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
			var _value7 = _step12.value;
	...
	var _a11 = Symbol.for('a');
	var _b8 = Symbol.for('a');
	console.log(_a11 === _b8);
	var _obj4 = (_obj5 = {}, _defineProperty(_obj5, _a11, '1'), _defineProperty(_obj5, 'a', '2'), _obj5);
	console.log(_obj4);
}

{
	var prize = function prize(count) {
		console.log('\u5269\u4F59\u62BD\u5956\u5B57\u6570: ' + count + '!');
	};
	var _f3 = /*#__PURE__*/regeneratorRuntime.mark(function _f3(count) {
		return regeneratorRuntime.wrap(function _f3$(_context5) {
			while (1) {
...
{
	var f1 = /*#__PURE__*/regeneratorRuntime.mark(function f1() {
		return regeneratorRuntime.wrap(function f1$(_context6) {
			while (1) {
...
{
	var _f4 = function _f4(a, b) {
		for (var _len2 = arguments.length, arg = Array(_len2 > 2 ? _len2 - 2 : 0), _key4 = 2; _key4 < _len2; _key4++) {
